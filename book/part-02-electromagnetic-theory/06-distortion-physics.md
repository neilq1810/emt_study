...
- Verify whether modern AC systems' "dynamic metal immunity" (vendor patents
  surfaced in research) materially changes the §6.2 conclusion; tag findings. One
  concrete mechanism is **transmitter-side sensing** — the generator measuring a
  distorter through its own reflected impedance/mutual inductance (Ch. 27 §27.7
  [@jaeger2018]) — and **drive-waveform pre-emphasis** (US 6,201,987 [@dumoulin2001]).
